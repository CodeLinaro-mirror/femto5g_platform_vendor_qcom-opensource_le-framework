...
typedef enum camera_metadata_enum_android_scaler_available_formats {
    ...
    ANDROID_SCALER_AVAILABLE_FORMATS_YCbCr_420_P010                  = 0x36, // HIDL v3.4
...
typedef enum camera_metadata_enum_android_info_supported_hardware_level {
    ...
    ANDROID_INFO_SUPPORTED_HARDWARE_LEVEL_HIGHPERF                  , // HIDL unsupported
...
// ANDROID_USECASE_TEMPLATE
typedef enum camera_metadata_enum_android_usecase_template {
    ANDROID_USECASE_TEMPLATE_DEFAULT            = 0,         // HIDL unsupported
    ANDROID_USECASE_TEMPLATE_HEAD_TRACKING      = 0x1 << 0,  // HIDL unsupported
    ANDROID_USECASE_TEMPLATE_HAND_TRACKING      = 0x1 << 1,  // HIDL unsupported
    ANDROID_USECASE_TEMPLATE_CONTROLLER         = 0x1 << 2,  // HIDL unsupported
    ANDROID_USECASE_TEMPLATE_PLANE_FINDING      = 0x1 << 3,  // HIDL unsupported
